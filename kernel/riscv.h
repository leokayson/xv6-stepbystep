...
/*
  | 分页模式 | 描述 | MODE 值 (二进制) | MODE 值 (十六进制) | 虚拟地址宽度 | 页表级数 |
  | :--- | :--- | :--- | :--- | :--- | :--- |
  | Bare | 无地址翻译 (直通) | `0000` | `0` | - | - |
  | Sv39 | 39位虚拟地址 | `1000` | `8` | 39-bit | 3级 |
  | Sv48 | 48位虚拟地址 | `1001` | `9` | 48-bit | 4级 |
  | Sv57 | 57位虚拟地址 | `1010` | `A` | 57-bit | 5级 |
  | Sv64 | 64位虚拟地址 | `1011` | `B` | 64-bit | 6级 |
*/
...
#define PGSIZE	4096 // 0x1000 bytes per page, 4KB
